                    ...
                    <div class="personnal-intel">
                        ...
                        <div class="fullname">
                            <div class="prenom">
                                <div class="input-field">
                                    ...
                                    <input  type="text" id="prenom" name="prenom" placeholder="Votre prénom.." onfocusout="verif_prenom_nom(this)">
                            ...
                            <div class="nom">
                                <div class="input-field">
                                    ...
                                    <input  type="text" id="nom" name="nom" placeholder="Votre nom.." onfocusout="verif_prenom_nom(this)">
                        ...
                        <div class="mail">
                            <div class="input-field">
                                ...
                                <input  type="text" id="email" name="email" placeholder="Votre email.." onfocusout   ="verif_mail(this)">
                            ...
                            <div class="right-intel">
                                <div class="job">
                                    <div class="input-field">
                                        ...
                                        <select id="job" name="job" onfocusout="verif_select(this)">
                                ...
                                <div class="bday">
                                    <div class="input-field">
                                        ...
                                        <input  id="bday" min="2002-09-03" type="date" id="birthday" name="birthday" onfocusout="verif_date(this)">
                    ...
                    <div class="message">
                        ...
                        <div class="subject">
                            <div class="input-field">
                                ...
                                <input  type="text" id="subject" name="subject" placeholder="Sujet..." onfocusout="verif_not_empty(this)">
                        ...
                        <div class="text-message">
                            <div class="input-field">
                                ...
                                <textarea id="message" name="message" placeholder="Votre message.." style="height:200px; resize: none;" onfocusout="verif_not_empty(this)"></textarea>
